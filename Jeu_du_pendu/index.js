...
function pendu() {
    ...
    switch (niveau) {
        case 5:
            console.log(niveau)
    motSecret = mots_5[Math.floor(Math.random() * mots_5.length)]; //mot[1]
            console.log(motSecret)
            break;
            case 6:
    motSecret = mots_6[Math.floor(Math.random() * mots_6.length)]; //mot[1]

            break;
            case 7:
    motSecret = mots_7[Math.floor(Math.random() * mots_7.length)]; //mot[1]
            
             break;
             case 8:
     motSecret = mots_8[Math.floor(Math.random() * mots_8.length)]; //mot[1]
                        
             break;
             case 9:
    motSecret = mots_9[Math.floor(Math.random() * mots_9.length)]; //mot[1]
                                    
            break;
            case 10:
     motSecret = mots_10[Math.floor(Math.random() * mots_10.length)]; //mot[1]
    ...
    while (nombrelettresManquantes > 0 && score > 0) {
        ...
        score--; // score = score + 
        alert(`Il vous reste ${score} essai(s)`)
    }
